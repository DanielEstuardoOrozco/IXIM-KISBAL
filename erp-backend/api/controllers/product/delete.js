    ...
    fn: async ( _, exits, env) => {
        ...
        try {
            ...
            await sails.getDatastore().transaction(async (db) => {
                ...
                deletedProduct = await sails.helpers.repository.updateOne(Product, {id: id}, data, db);
            });
            
            return sails.helpers.sendSuccess(ok)('Message.DeleteSuccessfully', { product: deletedProduct.toJSON()});
