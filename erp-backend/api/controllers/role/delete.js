    ...
    fn: async ( _, exits, env) => {
        ...
        try {
            ...
            await sails.getDatastore().transaction(async (db) => {
                ...
                deletedRole = await sails.helpers.repository.updateOne(Role, {id: id}, data, db);
            });
            
            return sails.helpers.sendSuccess(ok)('Message.DeleteSuccessfully', { role: deletedRole.toJSON()});
